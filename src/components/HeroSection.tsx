...
export default function HeroSection() {
  return (
    <section className="relative min-h-screen flex items-center justify-center px-4 overflow-hidden">
      <div className="absolute inset-0 bg-gradient-to-b from-black/60 via-transparent to-surface dark:to-gray-950" />
      <div className="relative text-center max-w-3xl z-10">
        ...
        <p className="mt-4 text-lg sm:text-xl text-gray-500 dark:text-gray-400 max-w-2xl mx-auto leading-relaxed">
        ...
        <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center">
          ...
          <a
            href="#contact"
            className="inline-flex items-center justify-center px-8 py-3 rounded bg-gray-200 dark:bg-gray-700 text-gray-900 dark:text-white font-semibold text-sm hover:bg-gray-300 dark:hover:bg-gray-600 transition-colors"
          >
            Hubungi Saya
          </a>
        </div>
